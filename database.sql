...
INSERT INTO `agenda` VALUES("1","rapat","2025-12-30","cafe","sfdjkjsdf","2025-12-31 01:23:59","");
INSERT INTO `agenda` VALUES("2","asdfjhksadlfh","2025-12-10","dfs","dsff","2026-01-01 22:44:34","");
INSERT INTO `agenda` VALUES("3","dsfadsfsf","2025-11-11","asdfasf","sadffa","2026-01-01 22:44:47","");
INSERT INTO `agenda` VALUES("4","adfsadfds","2026-01-16","adfa","asdf","2026-01-01 22:45:32","");
INSERT INTO `agenda` VALUES("5","ghfgj","2026-01-23","hjgh","dvzv","2026-01-02 00:01:24","1767286884_6956a864c6891.pdf");
...
INSERT INTO `berita` VALUES("1","Kementerian Agama Luncurkan Program Digitalisasi Madrasah 2025","kementerian-agama-luncurkan-program-digitalisasi-madrasah-2025","Berita","Admin Pusat","2025-01-02","https://images.unsplash.com/photo-1497633762265-9d179a990aa6?ixlib=rb-4.0.3","<p>Konten berita lengkap disini...</p>","0","2025-12-31 00:12:21");
INSERT INTO `berita` VALUES("2","Implementasi Kurikulum Merdeka di Tingkat Madrasah Ibtidaiyah","implementasi-kurikulum-merdeka-di-tingkat-madrasah-ibtidaiyah","Kurikulum","Admin","2024-12-28","https://images.unsplash.com/photo-1427504494785-3a9ca7044f45?ixlib=rb-4.0.3","<p>Panduan lengkap bagi guru...</p>","1","2025-12-31 00:12:21");
INSERT INTO `berita` VALUES("3","Siswa MI Kota Contoh Raih Medali Emas Olimpiade Sains Nasional","siswa-mi-medali-emas","Prestasi","Humas","2024-12-15","https://images.unsplash.com/photo-1571260899304-425eee4c7efc?ixlib=rb-4.0.3","Prestasi membanggakan kembali ditorehkan...","0","2025-12-31 00:12:21");
...
INSERT INTO `galeri` VALUES("1","Lomba Adzan Siswa MI","2025-12-10","https://images.unsplash.com/photo-1599547525367-17eb48679cb1?ixlib=rb-4.0.3","2026-01-01 21:42:55");
INSERT INTO `galeri` VALUES("2","Pelatihan Guru Fiqih","2025-11-20","assets/img/galeri/6956881014ed9_galeri.jpg","2026-01-01 21:42:55");
INSERT INTO `galeri` VALUES("3","Rapat Kerja Tahunan","2025-10-15","https://images.unsplash.com/photo-1577962917302-cd874c4e31d2?ixlib=rb-4.0.3","2026-01-01 21:42:55");
INSERT INTO `galeri` VALUES("4","Kunjungan Kemenag","2025-09-05","https://images.unsplash.com/photo-1558403194-611308249627?ixlib=rb-4.0.3","2026-01-01 21:42:55");
INSERT INTO `galeri` VALUES("5","dsafds","2026-01-01","assets/img/galeri/6956a209108db_thumb.jpg","2026-01-01 23:34:17");
...
CREATE TABLE `galeri_foto` (
  ...
  CONSTRAINT `galeri_foto_ibfk_1` FOREIGN KEY (`id_galeri`) REFERENCES `galeri` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

INSERT INTO `galeri_foto` VALUES("1","2","assets/img/galeri/6956899537fe3_sub_0.jpg");
INSERT INTO `galeri_foto` VALUES("2","2","assets/img/galeri/695689953c439_sub_1.jpg");
INSERT INTO `galeri_foto` VALUES("3","2","assets/img/galeri/695689953ef8e_sub_2.jpg");
INSERT INTO `galeri_foto` VALUES("4","2","assets/img/galeri/695689953fff3_sub_3.jpg");
...
INSERT INTO `guru` VALUES("1","Guru 1","","MI A","Aktif","2026-01-01 22:04:06");
INSERT INTO `guru` VALUES("2","Guru 2","","MI B","Aktif","2026-01-01 22:04:06");
INSERT INTO `guru` VALUES("3","Budi Santoso S.Pd","","MI Darul Ulum","Aktif","2026-01-01 22:12:32");
INSERT INTO `guru` VALUES("4","Siti Aminah S.Pd.I","","MI Nurul Huda","Aktif","2026-01-01 22:12:32");
INSERT INTO `guru` VALUES("5","Ahmad Fauzi S.Pd","","MI Al-Ikhlas","Aktif","2026-01-01 22:31:31");
INSERT INTO `guru` VALUES("6","Siti Nurhaliza","","MI Darussalam","Aktif","2026-01-01 22:31:31");
INSERT INTO `guru` VALUES("8","Ahmad Fauzi S.Pd","","MI Al-Ikhlas","Aktif","2026-01-01 22:31:31");
INSERT INTO `guru` VALUES("9","Siti Nurhaliza","","MI Darussalam","Aktif","2026-01-01 22:31:31");
INSERT INTO `guru` VALUES("10","Budi Santoso","","MI Nurul Huda","Non-Aktif","2026-01-01 22:31:31");
INSERT INTO `guru` VALUES("11","Ahmad Fauzi S.Pd","","MI Al-Ikhlas","Aktif","2026-01-01 22:31:31");
INSERT INTO `guru` VALUES("12","Siti Nurhaliza","","MI Darussalam","Aktif","2026-01-01 22:31:31");
INSERT INTO `guru` VALUES("13","Budi Santoso","","MI Nurul Huda","Non-Aktif","2026-01-01 22:31:31");
INSERT INTO `guru` VALUES("14","Ahmad Fauzi S.Pd","","MI Al-Ikhlas","Aktif","2026-01-01 22:31:31");
INSERT INTO `guru` VALUES("15","Siti Nurhaliza","","MI Darussalam","Aktif","2026-01-01 22:31:31");
INSERT INTO `guru` VALUES("16","Budi Santoso","","MI Nurul Huda","Non-Aktif","2026-01-01 22:31:31");
...
INSERT INTO `pengurus` VALUES("1","Muhamad Khafiduddin, S.Sos","Ketua KKG","https://ui-avatars.com/api/?name=Ahmad+Fauzi&background=059669&color=fff","1","2025-12-31 00:12:21");
INSERT INTO `pengurus` VALUES("2","M. Ali Maliki","Sekretaris","https://ui-avatars.com/api/?name=Siti+Aminah&background=059669&color=fff","3","2025-12-31 00:12:21");
INSERT INTO `pengurus` VALUES("3","Eva Fauziyana, S.Pd.I","Bendahara","https://ui-avatars.com/api/?name=Rina+Wati&background=059669&color=fff","4","2025-12-31 00:12:21");
INSERT INTO `pengurus` VALUES("4","Diyah Karlita, AF","Wakil Bendahara","https://ui-avatars.com/api/?name=Budi+Santoso&background=059669&color=fff","5","2025-12-31 00:12:21");
INSERT INTO `pengurus` VALUES("5","Yusuf Asy\'Ari, S.Pd.I","Wakil Ketua","","2","2026-01-01 21:17:31");
...
DROP TABLE IF EXISTS `rdm_links`;
...
INSERT INTO `rdm_links` VALUES("1","MI Raden Fatah 01 Grobog Wetan","https://rdm.mirafa01.web.id","2026-01-01 22:46:28","rdm_1767282885.png");
INSERT INTO `rdm_links` VALUES("2","MI Darul Ulum","https://rdm.kemenag.go.id","2026-01-01 22:46:28","");
...
INSERT INTO `unduhan` VALUES("1","RPP Kurikulum Merdeka - Fiqih Kelas 1","Perangkat Ajar","rpp_fiqih_k1.pdf","pdf","2.5 MB","Ustadz Amin","2025-12-31 00:12:21");
INSERT INTO `unduhan` VALUES("2","Kalender Pendidikan Madrasah 2025/2026","Regulasi","kaldik_2025.docx","docx","1.2 MB","Admin Pusat","2025-12-31 00:12:21");
INSERT INTO `unduhan` VALUES("3","Modul Ajar Bahasa Arab Kelas 4","Perangkat Ajar","modul_b_arab_k4.xlsx","xlsx","500 KB","Ustadzah Siti","2025-12-31 00:12:21");
INSERT INTO `unduhan` VALUES("4","tes","Perangkat Ajar","695687d06256d_1222-2754-1-SM.pdf","pdf","978.88 KB","Administrator","2026-01-01 21:42:24");
...
INSERT INTO `users` VALUES("1","admin","$2a$12$cMNLcd9RoGJI7PJ4sVCc6Ou4fBGNSZg4A6ZNvxQQCxf2r0SUUa55a","Administrator","admin","2025-12-31 00:12:21");
